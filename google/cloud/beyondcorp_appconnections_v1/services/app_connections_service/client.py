...
class AppConnectionsServiceClient(metaclass=AppConnectionsServiceClientMeta):
    ...
    @staticmethod
    def app_connection_path(
        project: str,
        location: str,
        app_connection: str,
    ) -> str:
        """Returns a fully-qualified app_connection string."""
        return "projects/{project}/locations/{location}/appConnections/{app_connection}".format(
            project=project,
            location=location,
    ...
    def parse_app_connection_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appConnections/(?P<app_connection>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def app_connector_path(
        project: str,
        location: str,
        app_connector: str,
    ) -> str:
        """Returns a fully-qualified app_connector string."""
        return "projects/{project}/locations/{location}/appConnectors/{app_connector}".format(
            project=project,
            location=location,
    ...
    def parse_app_connector_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appConnectors/(?P<app_connector>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
