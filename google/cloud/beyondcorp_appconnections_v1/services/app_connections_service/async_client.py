...
class AppConnectionsServiceAsyncClient:
    ...
    parse_app_connection_path = staticmethod(
        AppConnectionsServiceClient.parse_app_connection_path
    )
    app_connector_path = staticmethod(AppConnectionsServiceClient.app_connector_path)
    parse_app_connector_path = staticmethod(
        AppConnectionsServiceClient.parse_app_connector_path
    )
    app_gateway_path = staticmethod(AppConnectionsServiceClient.app_gateway_path)
    parse_app_gateway_path = staticmethod(
        AppConnectionsServiceClient.parse_app_gateway_path
    )
    common_billing_account_path = staticmethod(
        AppConnectionsServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        AppConnectionsServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(AppConnectionsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        AppConnectionsServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        AppConnectionsServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        AppConnectionsServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(AppConnectionsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        AppConnectionsServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        AppConnectionsServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        AppConnectionsServiceClient.parse_common_location_path
    )
