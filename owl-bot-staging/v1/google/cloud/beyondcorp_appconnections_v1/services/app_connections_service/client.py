...
class AppConnectionsServiceClientMeta(type):
    """Metaclass for the AppConnectionsService client.
...
class AppConnectionsServiceClient(metaclass=AppConnectionsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AppConnectionsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AppConnectionsServiceTransport:
        ...
        Returns:
            AppConnectionsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def app_connection_path(project: str,location: str,app_connection: str,) -> str:
        """Returns a fully-qualified app_connection string."""
        return "projects/{project}/locations/{location}/appConnections/{app_connection}".format(project=project, location=location, app_connection=app_connection, )

    @staticmethod
    def parse_app_connection_path(path: str) -> Dict[str,str]:
        """Parses a app_connection path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appConnections/(?P<app_connection>.+?)$", path)
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, AppConnectionsServiceTransport):
            # transport is a AppConnectionsServiceTransport instance.
    ...
    def list_app_connections(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_app_connections]
        ...
        response = pagers.ListAppConnectionsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_app_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_app_connection]
    ...
    def create_app_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_app_connection]
    ...
    def update_app_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_app_connection]
    ...
    def delete_app_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_app_connection]
    ...
    def resolve_app_connections(self,
            request: Union[app_connections_service.ResolveAppConnectionsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resolve_app_connections]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ResolveAppConnectionsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
